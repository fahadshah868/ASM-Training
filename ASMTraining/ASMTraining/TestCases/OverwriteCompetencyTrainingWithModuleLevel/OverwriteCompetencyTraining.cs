...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='DSF Rating Summery') on item 'ASMTraining.Validate_DSFRatingSummaryScreen'.", repo.ASMTraining.Validate_DSFRatingSummaryScreenInfo, new RecordItemIndex(50));
